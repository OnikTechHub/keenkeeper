...
const FriendDetails = () => {
    ...
    const handleCall = () => {
        setCall([...call, data])
        toast.success( ` Call with ${data.name} added to timeline!`)
    }

    const handleText = () => {
        setText([...text, data])
        toast.success(` Text with ${data.name} added to timeline!`)
    }

    const handleVideo = () => {
        setVideo([...video, data])
        toast.success(` Video with ${data.name} added to timeline!`)
    }
        ...
        <div className=' bg-gray-50 '>
            ...
            <div className="w-8/12 mx-auto py-20 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow p-6 text-center">
                    ...
                    <h2 className="text-1xl text-gray-400 mt-1"> {data.email}</h2>
